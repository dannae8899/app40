...
def main(page: ft.Page):
    ...
    def on_calc_suma(e):
        calc_suma(txtNum1,txtNum2,1lblResulatdo)
        page.update()
        
    def on_calc_resta(e):
        calc_resta(txtnNum1,txtNum2,1lblresultado)
        page.update()
        
    def on_calc_multiplicacion(e):
        calc_multiplicacion(txtNum1,txtNum2,1lblResulatdo)
        page.update()
        
    def on_calc_division(e):
        calc_division(txtNum1,txtNum2,1lblResulatdo)
